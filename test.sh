...
swiftc -I Sources/CSMC/include Sources/StatusMonitor/Battery.swift Sources/StatusMonitor/Sensors.swift Sources/StatusMonitor/Network.swift Sources/StatusMonitor/Preferences.swift Sources/StatusMonitor/SystemSampler.swift Tests/MonitorTests.swift .build/checks/smc.o -framework IOKit -o .build/checks/monitor-tests
